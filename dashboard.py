...
#Decomposição
    ...
    img_codedec = r'https://github.com/giogioanima/Tech-Challenge-02/blob/main/img/codedec.PNG'
    st.image(img_codedec, use_column_width=False)
    st.write(" ")
    img_path = r'https://github.com/giogioanima/Tech-Challenge-02/blob/main/img/decomp.png'
    ...
    img_adf1 = r'https://github.com/giogioanima/Tech-Challenge-02/blob/main/img/test_adf1.png'
...
with tab2:
    ...
    if option == "Modelo de Média Móvel (MA)":
        ...
        with coluna7:
            ...
            img_MAmape = r'https://github.com/giogioanima/Tech-Challenge-02/blob/main/img/MA_mape.png'
        ...
        with coluna8:
            ...
            img_diff = r'https://github.com/giogioanima/Tech-Challenge-02/blob/main/img/diff.png'
        ...
        with coluna9:
            ...
            img_acf = r'https://github.com/giogioanima/Tech-Challenge-02/blob/main/img/acf.png'
        ...
        with coluna10:
            ...
            img_arima = r'https://github.com/giogioanima/Tech-Challenge-02/blob/main/img/arima.png'
        ...
        with coluna11:
            ...
            img_mapearima = r'https://github.com/giogioanima/Tech-Challenge-02/blob/main/img/mapearima.png'
        ...
        with coluna12:
            ...
            img_dsy = r'https://github.com/giogioanima/Tech-Challenge-02/blob/main/img/ds_y.png'
            ...
            img_prop = r'https://github.com/giogioanima/Tech-Challenge-02/blob/main/img/prophet.png'
            st.image(img_prop, use_column_width=True)
            img_change = r'https://github.com/giogioanima/Tech-Challenge-02/blob/main/img/changepoints.png'
        ...
        with coluna13:
            ...
            img_propdec = r'https://github.com/giogioanima/Tech-Challenge-02/blob/main/img/propdec.png'
            ...
            st.write(" ")
            st.markdown(':mag_right: <h class="about3-style">Validando com Mean Absolute Percentage Error (MAPE)</h>', unsafe_allow_html=True)
            img_propmape = r'https://github.com/giogioanima/Tech-Challenge-02/blob/main/img/propmape.png'
