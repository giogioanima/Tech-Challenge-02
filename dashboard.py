...
#Decomposição
    ...
    img_codedec = Image.open(r'/img/codedec.png')
    ...
    img_adf1 = Image.open(r'/img/test_adf1.png')
...
with tab2:
    ...
    if option == "Modelo de Média Móvel (MA)":
        ...
        with coluna7:
            ...
            img_MAmape = Image.open(r'/img/MA_mape.png')
        ...
        with coluna11:
            ...
            img_mapearima = Image.open(r'/img/mapearima.png')
        ...
        with coluna12:
            ...
            img_dsy = Image.open(r'/img/ds_y.png')
        ...
        with coluna13:
            ...
            st.write(" ")
            st.markdown(':mag_right: <h class="about3-style">Validando com Mean Absolute Percentage Error (MAPE)</h>', unsafe_allow_html=True)
            img_propmape = Image.open(r'/img/propmape.png')
