...
#df = pd.read_csv(r"img/Dados Históricos - Ibovespa Fase 02.csv", sep=",")
...
#Decomposição
    ...
    img_codedec = Image.open(r'img/img\codedec.png')
    st.image(img_codedec, use_column_width=False)
    st.write(" ")
    
    img_path = Image.open(r'img/img\decomp.png')
    ...
    img_adf1 = Image.open(r'img/img\test_adf1.png')
...
with tab2:
    ...
    if option == "Modelo de Média Móvel (MA)":
        ...
        with coluna7:
            ...
            img_MAmape = Image.open(r'img/img\MA_mape.png')
        ...
        with coluna8:
            ...
            img_diff = Image.open(r'img/img\diff.png')
        ...
        with coluna9:
            ...
            img_acf = Image.open(r'img/img\acf.png')
        ...
        with coluna10:
            ...
            img_arima = Image.open(r'img/img\arima.png')
        ...
        with coluna11:
            ...
            img_mapearima = Image.open(r'img/img\mapearima.png')
        ...
        with coluna12:
            ...
            img_dsy = Image.open(r'img/img\ds_y.png')
            ...
            img_prop = Image.open(r'img/img\prophet.png')
            st.image(img_prop, use_column_width=True)
            img_change = Image.open(r'img/img\changepoints.png')
        ...
        with coluna13:
            ...
            img_propdec = Image.open(r'img/img\propdec.png')
            ...
            st.write(" ")
            st.markdown(':mag_right: <h class="about3-style">Validando com Mean Absolute Percentage Error (MAPE)</h>', unsafe_allow_html=True)
            img_propmape = Image.open(r'img/img\propmape.png')
