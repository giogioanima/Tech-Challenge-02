...
st.markdown("- Optamos por uma abordagem em séries temporais, considerando a complexidade dos dados e a necessidade de previsões diárias confiáveis. Utilizamos Python e suas bibliotecas especializadas, explorando métodos como média móvel, ARIMA e Prophet em busca do melhor desempenho para garantir análises precisas das flutuações do IBOVESPA.")
...
#Decomposição
    ...
    img_codedec = Image.open('img/codedec.png')
    st.image(img_codedec, use_column_width=False)
    st.write(" ")
    
    img_path = Image.open('img/decomp.png')
    ...
    img_adf1 = Image.open('img/test_adf1.png')
...
with tab2:
    ...
    if option == "Modelo de Média Móvel (MA)":
        ...
        with coluna7:
            ...
            img_MAmape = Image.open('img/MA_mape.png')
        ...
        with coluna8:
            ...
            img_diff = Image.open('img/diff.png')
        ...
        with coluna9:
            ...
            img_acf = Image.open('img/acf.png')
        ...
        with coluna10:
            ...
            img_arima = Image.open('img/arima.png')
        ...
        with coluna11:
            ...
            img_mapearima = Image.open('img/mapearima.png')
        ...
        with coluna12:
            ...
            img_dsy = Image.open('img/ds_y.png')
            ...
            img_prop = Image.open('img/prophet.png')
            st.image(img_prop, use_column_width=True)
            img_change = Image.open('img/changepoints.png')
        ...
        with coluna13:
            ...
            img_propdec = Image.open('img/propdec.png')
            ...
            st.write(" ")
            st.markdown(':mag_right: <h class="about3-style">Validando com Mean Absolute Percentage Error (MAPE)</h>', unsafe_allow_html=True)
            img_propmape = Image.open('img/propmape.png')
